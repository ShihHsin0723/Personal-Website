    ...
    <Container class='education-section'>
        <Row className='item'>
          <Col lg={4} className="title text-center">
            ...
            <h5>Statistics & Mathematics Minors</h5>
          ...
          <Col className='event' lg={7}>
            <div className='right-block'>
              ...
              <ul className='listItems'>
                ...
                <li>Only Human Dance Company Marketing/Social Media Director</li>
      ...
      <Row className='item'>
        ...
        <Col className='event' lg={7}>
            ...
            <ul className="listItems">
                ...
                <li>Capital Region BOCEs 30th Annual Art Show Selected Participant</li>
            </ul>
            </div>
        </Col>
      </Row>
